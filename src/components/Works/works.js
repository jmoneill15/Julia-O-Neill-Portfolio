        ...
        <section id="works">
            ...
            <a href="https://jmoneill15.github.io/tasks/"  target="_blank" rel="noopener noreferrer"><img src={ciscwebsiteLogo} alt="CISC275 Website" className="worksImg"/></a>
                ...
                <span className = "title">CISC275 Website <br/></span>
                    <span className = "description">An assignment for my Intro to Software Engineering course, which implementing Typescript and React hooks to create various components.</span>
                </div>
            </div>
            </div>
